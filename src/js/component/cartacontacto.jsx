...
import { ModalEditarContacto } from "./modaleditarcontacto.jsx";
  ...
  return (
	...
	<div className="row g-0">
	  <div className="col-md-2 d-flex justify-content-center align-items-center">
		<img src={`https://picsum.photos/200/200?random=${id}`} className="img-fluid rounded-circle m-3" alt="Random"/>
	  </div>
	  ...
	  <button className="btn mx-2" style={{ cursor: 'pointer' }} onClick={nuevoId} data-bs-toggle="modal" data-bs-target="#editar">
